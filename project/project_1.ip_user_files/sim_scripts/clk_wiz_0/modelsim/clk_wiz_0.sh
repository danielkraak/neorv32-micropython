...
#
# Generated by Vivado on Mon Sep 30 09:20:32 CEST 2024
...
copy_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="/home/daniel/git-dropbox/softcore_micropython/project/project_1.cache/compile_simlib/modelsim"
  fi
